...
class SSD_resnet:
    ...
    def generate_graph(self):
        ...
        print("fuck all-----feature_class", self.feature_class)
        print("fuck out-----groundtruth_class", self.groundtruth_class)
        ...
        print("fuck!!!!------softmax_cross_entropy", self.softmax_cross_entropy)
    ...
    def generate_groundtruth_data(self,input_actual_data, f_class):
        ...
        for img_index in range(input_actual_data_len):
            for pre_actual in input_actual_data[img_index]:
                ...
                print("==============================================")
                print("gt_class_val", gt_class_val)
                print("==============================================")
